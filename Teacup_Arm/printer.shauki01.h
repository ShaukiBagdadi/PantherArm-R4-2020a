...
*/
#define STEPS_PER_M_X            40000//170695  // 1./1.8*16.*(19.+(38./187.)) 
#define STEPS_PER_M_Y            40000//1963250 // 1./1.8*16.*(51.+(0.1818))*(94.0+1.8)/(24.0-1.8) 
#define STEPS_PER_M_Z            40000//1963250 // 1./1.8*16.*(51.+(0.1818))*(94.0+1.8)/(24.0-1.8)
#define STEPS_PER_M_U            40000//4417312 // 1963250*36/16
#define STEPS_PER_M_E            256000  // Knurling feeder 
...
#define MAXIMUM_FEEDRATE_U       6000
...
#define ENDSTOP_CLEARANCE_U      500
...
/** \def ACCELERATION_REPRAP ACCELERATION_RAMPING ACCELERATION_TEMPORAL
  ...
  the acceleration of Teacup is not implemented properly
  see http://forums.reprap.org/read.php?147,33082,403114,page=51
*/
...
/** \def USE_INTERNAL_PULLDOWNS
  ...
  time, of course.
*/
//#define USE_INTERNAL_PULLDOWNS // attmegas do not support pulldown resistors
...
/** \def MOVEBUFFER_SIZE
  ...
  Note that each move takes a fair chunk of ram (107 bytes as of this writing), // SHAUKI with U is bigger now
